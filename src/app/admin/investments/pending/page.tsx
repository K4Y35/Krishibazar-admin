  ...
  const fetchInvestments = async () => {
    try {
      ...
      if (response.success) {
        ...
        toast.error("Failed to fetch pending investments");
      }
    } catch (err) {
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <Breadcrumb pageName="Pending Investments" />
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-black dark:text-white">
            Pending Investments
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Review and confirm incoming investment requests
          </p>
        </div>
